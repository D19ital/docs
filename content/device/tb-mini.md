...
![image](/images/tb-mini-v3/trackball_v3_1_down_ru.png)

1. Переключатель питания  
2. Кнопка (v3.1): однократное нажатие — переключение BT‑профиля (0–5 по кругу), двукратное нажатие (быстро) — очистка текущего BT‑профиля  
3. Кнопка (v3.1): однократное нажатие — переключение на 0‑й BT‑профиль, двукратное нажатие (быстро) — очистка всех BT‑профилей  
...
Трекбол третьей версии, как и другие девайсы на ZMK, может быть привязан к 6 устройствам, и после привязки трекбол можно переключать между ними нажатием пары клавиш.

<details>
<summary>Trackball Mini v3.0</summary>

Для подключения трекбола к дополнительным устройствам потребуется использовать *слой настроек*. Чтобы попасть на этот слой, одновременно нажмите обе клавиши трекбола два раза подряд.  
...
<details>
<summary>Trackball Mini v3.1</summary>

Для подключения трекбола к дополнительным устройствам используйте кнопку **2** на нижней части корпуса. Где, однократное нажатие — переключит BT‑профиль на следующий за текущим (0–5 по кругу), быстрое двукратное нажатие — очистит текущий BT‑профиль.

Если вам нужно вернуться на нулевой BT‑профиль, однократно нажмите кнопку **3**, чтобы очистить все профили, 2 раза быстро нажмите эту же кнопку.
...
Прошивка и мониторинг заряда происходят аналогично <a href="https://docs.eh.works/software/zmk/zmk-keyboards/" target="_blank">беспроводным клавиатурам на ZMK</a>.
