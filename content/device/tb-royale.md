...
[Зарядка и мониторинг заряда](https://docs.eh.works/software/zmk/zmk-keyboards/#%d1%81%d0%be%d1%81%d1%82%d0%be%d1%8f%d0%bd%d0%b8%d0%b5-%d0%b1%d0%b0%d1%82%d0%b0%d1%80%d0%b5%d0%b8) происходят аналогично беспроводным клавиатурам на ZMK
...
На клавиши трекбола можно назначить любое **поведение** с помощью [keymap editor](https://docs.eh.works/software/zmk/keymap-editor/)
...
Скачайте актуальные файлы прошивок *settings_reset* и *Trackball Royale* со [страницы с прошивками](https://docs.eh.works/firmware/)
