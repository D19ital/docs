...
2. **If you don't have your own fork:** Download the ready-made standard firmware from the <a href="https://docs.eh.industries/firmware/" target="_blank">firmware page</a>. You will also need three `.uf2` files.

Additionally, you will need a **reset firmware** (`settings_reset-ergohaven-zmk.uf2`). Usually, it can be found in the same place as the main firmware, or on the <a href="https://docs.eh.industries/firmware/" target="_blank">firmware page</a>.
