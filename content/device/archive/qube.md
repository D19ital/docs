...
2. **Если у вас нет своего форка:** Скачайте готовую стандартную прошивку на <a href="https://docs.eh.works/firmware/" target="_blank">странице с прошивками</a> Вам также понадобятся три `.uf2` файла.

Дополнительно вам потребуется **Reset прошивка** (`settings_reset-ergohaven-zmk.uf2`). Обычно её можно найти там же, где и основную прошивку, или на <a href="https://docs.eh.works/firmware/" target="_blank">странице с прошивками</a>.
