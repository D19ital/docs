...
2. **Если у вас нет своего форка:** Скачайте готовую стандартную прошивку на <a href="https://docs.ergohaven.xyz/firmware/" target="_blank">странице с прошивками</a> Вам также понадобятся три `.uf2` файла.

Дополнительно вам потребуется **Reset прошивка** (`settings_reset-ergohaven-zmk.uf2`). Обычно её можно найти там же, где и основную прошивку, или на <a href="https://docs.ergohaven.xyz/firmware/" target="_blank">странице с прошивками</a>.
...
## Добавление беспроводного подключения к устройствам через Qube

> Сплит-клавиатуры Ergohaven с использованием донгла Qube можно подключать к разным устройствам с сохранением профилей подключения (до 6-ти устройств), при этом один профиль подключения - проводной по кабелю USB, а остальные 5 профилей - по беспроводной связи Bluetooth

1. Подключите Qube к основному устройству через кабель USB 
> Если нужно подключить несколько дополнительных устройств по Bluetooth, то необходимо активировать на клавиатуре желаемый номер профиля под каждое устройство (3 слой в раскладке по умолчанию)
2. На дополнительном устройстве находим клавиатуру в списке Bluetooth устройств и подключаемся к ней
3. На самой клавиатуры переводим тип подключения на беспроводной при помощи кнопки  OUT BLE (3 слой в раскладке по умолчанию)
4. Для возврата на проводное подключение переключитесь на него при помощи кнопки  OUT USB (3 слой в раскладке по умолчанию)
