...
To use the encoder, touchpad, or trackball module, enable it in the keyboard settings. Open the [Entropy](https://github.com/ergohaven/entropy) configurator, select **Settings** - **Module settings** at the top of the main configurator window, choose the required half under **Side of module**, and choose the connected module under **Module**.
