...
To use the encoder, touchpad, or trackball module, enable it in the keyboard settings. Open the [Entropy](https://github.com/ergohaven/entropy) configurator, select **Configuration** - **Module settings** at the top of the main configurator window, and choose the required module from the drop-down list next to **Module**.
...
If you have any questions about setup, firmware, or operation, contact the corresponding Ergohaven Telegram groups or use the [knowledge base](https://docs.ergohaven.xyz/en/).
