...
**Пример:** Gateron Red KS-33 LP 3.0 (50 г, низкопрофильные)
  {{< /tab >}}
  {{< tab >}}
...
**Примеры:** Gateron Brown KS-33 LP 3.0 (55 г, низкопрофильные), Outemu Silent Tom (50 г, бесшумные)
  {{< /tab >}}
{{< /tabs >}}
...
|--------|--------|----------|----------------------------|
| **60%** | ~60 | Полный алфавит, без цифрового ряда. Хороший баланс для новичков | *K:04*, *Phenom* **(58 клавиш)** |
| **40%** | ~36–46 | Ультракомпактный. Требует активного использования слоёв | *K:04 Micro* **(36 клавиш)**, *K:04 Mini* **(46 клавиш)**, *Phenom Micro* **(40 клавиш)**, *Phenom Mini* **(46 клавиш)** |

### Форм-фактор: корпус

{{< tabs items="Плоские,Изогнутые" >}}
  {{< tab >}}
