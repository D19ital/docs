...
After downloading the `firmware` archive, flash the keyboard with the files from it, following the steps described in the <a href="https://docs.eh.industries/software/zmk/zmk-keyboards/#keyboard-firmware" target="_blank">First steps with a Keyboard on ZMK</a> (see the "Keyboard firmware" section).
