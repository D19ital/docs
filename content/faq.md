...
Для переназначения клавиш и настройки клавиатуры используйте конфигуратор [Entropy](https://github.com/ergohaven/entropy). Инструкции по настройке читайте в [документации](https://docs.eh.works/)
