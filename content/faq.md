...
Для переназначения клавиш и настройки клавиатуры используйте конфигуратор [Entropy](https://github.com/ergohaven/entropy). Инструкции по настройке читайте в соответсующей для клавиатуры [документации](https://docs.ergohaven.xyz/)

### Как сделать, чтоб символы были на одном и том же месте вне зависимости от раскладки?
Используйте **Универсальные символы** в конфигураторе [Entropy](https://github.com/ergohaven/entropy)
